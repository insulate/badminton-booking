    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center mb-6">
        ...
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">เวลาทำการ</h1>
            <p className="text-gray-600 text-sm">กำหนดเวลาเปิด-ปิดและวันทำการ</p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
            ...
            <button
              type="submit"
              disabled={saving}
              className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition flex items-center disabled:bg-green-400 disabled:cursor-not-allowed"
            >
              {saving ? (
                <>
